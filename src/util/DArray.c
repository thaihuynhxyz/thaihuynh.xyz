...
int DArray_expand(DArray *array) {
    ...
    check(!DArray_resize(array, array->max + array->expand_rate), "Failed to expand array to new size: %d",
...
void *DArray_pop(DArray *array) {
    ...
    if (DArray_end(array) > (int) array->expand_rate && DArray_end(array) % array->expand_rate) DArray_contract(array);
